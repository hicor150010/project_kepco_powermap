...
export default function LocationSummaryCard({
  ...
  if (loading || !rows || rows.length === 0) {
    return (
      <div className="absolute left-4 right-4 bottom-16 md:left-4 md:right-auto md:bottom-20 md:w-[380px] max-w-[calc(100%-32px)] md:max-w-[calc(100%-32px)] bg-white rounded-xl shadow-2xl border border-gray-200 p-6 z-10 kepco-slide-up">
  ...
  return (
    <div className="absolute left-4 right-4 bottom-14 md:left-4 md:right-auto md:bottom-20 md:w-[380px] max-w-[calc(100%-32px)] md:max-w-[calc(100%-32px)] bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden z-10 flex flex-col max-h-[calc(100dvh-180px)] kepco-slide-up">
      {/* 헤더 — 위치명 + 총 건수 + 상세보기 */}
