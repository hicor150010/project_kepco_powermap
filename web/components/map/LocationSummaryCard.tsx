...
export default function LocationSummaryCard({
  ...
  if (loading || !rows || rows.length === 0) {
    return (
      <div className="absolute left-4 bottom-4 w-[380px] max-w-[calc(100%-32px)] bg-white rounded-xl shadow-2xl border border-gray-200 p-6 z-10">
  ...
  return (
    <div className="absolute left-4 bottom-4 w-[380px] max-w-[calc(100%-32px)] bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden z-10 flex flex-col max-h-[calc(100vh-120px)]">
      {/* 헤더 — 위치명 + 총 건수 */}
